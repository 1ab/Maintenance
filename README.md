...
- maintenanceapp-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- maintenanceapp-ui: main application module, development time
- maintenanceapp-production: module that produces a production mode WAR for deployment
