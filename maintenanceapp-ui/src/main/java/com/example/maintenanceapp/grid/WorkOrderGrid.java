 ...
 * data sets.
 */
public class WorkOrderGrid extends Grid<WorkOrder> {

	public WorkOrderGrid() {
		setSizeFull();

		addColumn(WorkOrder::getId, new NumberRenderer()).setCaption("Id");
		addColumn(WorkOrder::getName).setCaption("Name");
		addColumn(WorkOrder::getType).setCaption("Type");
	...
	public void refresh(WorkOrder job) {
